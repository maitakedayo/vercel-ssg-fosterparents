      ...
      <Layout>
          <div className="text-center bg-blue-100 p-8">
            ...
            <p className="text-lg mt-4">
              ...
              Some may argue that there are no secrets to the skills test, but in reality, that is not the case. The mindset and actions of those who pass are different from beginners. Just like the <strong className="text-blue-500">multiple-choice questions</strong> on the written test, there are also ✖️s on the skills test. So, what becomes an ✖️? To pass, you need to memorize many anti-patterns in advance, but memorizing all traffic laws is not realistic.<br/>
              Therefore, lets focus on memorizing only the 〇. <strong className="text-orange-500">In fact, those answers are available on the internet.</strong><br/>
              ...
              Below, we will explain the important points by acquisition type.
            </p>
            <p className="text-lg mt-4">
